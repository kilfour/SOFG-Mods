...
namespace Witching.Traits
{
    public class Soothsayer : T_ChallengeBooster
    {
        ...
        {
            return "Any newly hired Soothsayer immediately becomes the prophet of their coven. Gain 3 progress per turn when performing challenges relating to Religion.";
        }
